...
from eval.evaluation_helper import compute_nmae_from_behavior_files, compute_hota_at_05_trackeval, build_trackeval_structure, list_video_ids, natural_key
...
if __name__ == "__main__":
    simulate_and_eval_hota05(
        dataset_root="C:/Users/ciroc/Desktop/AV_project/data/datasets/SoccerNet/tracking/test1",
        predictions_root="C:/Users/ciroc/Desktop/AV_project/data/models/evaluation/soccana_1cls_640_smoothed",
        group="01",
        fps=200.0,
        split="test",
        show_window=False,
